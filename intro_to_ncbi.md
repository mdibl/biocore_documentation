...
The front page of NCBI acts as a hub, with the main source of navigation being the Entrez search bar, and the database selection menu to the left. 
...
As this is just an introduction to NCBI, a guide to searching using Entrez will follow in a seperate tutorial.
...
* Central online archive for raw sequence data, 
